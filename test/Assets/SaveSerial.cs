...
public class SaveSerial : MonoBehaviour
{
    ...
    float floatToSave;
    bool boolToSave;
    public int[] inventToSave;
    List<ItemStats> itemStatsToSave = new List<ItemStats>();
    private void Awake()
    {
        itemStatsToSave.Add(new ItemStats() { PartName = "crank arm", PartId = 1234 });
    }
    void OnGUI()
    {
    ...
    class SaveData
    {
        ...
        public int[] savedInvent;
        public List<ItemStats> savedItemStats;
    }
    void SaveGame()
    {
        ...
        data.savedInvent = inventToSave;
        data.savedItemStats = itemStatsToSave;
    ...
    void LoadGame()
    {
          ...
          + "/MySaveData.dat"))
        {
            ...
            inventToSave = data.savedInvent;
            itemStatsToSave = data.savedItemStats;
